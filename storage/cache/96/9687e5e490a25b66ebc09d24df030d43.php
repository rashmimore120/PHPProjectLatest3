...
/* invoices/index.twig */
class __TwigTemplate_06e9fad1d9eac600972392b726e0aa0c extends Template
{
    private $source;
    private $macros = [];
...
<table>
  ...
  <tbody>
    ";
        ...
        <td>\$";
            // line 28
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["invoice"], "amount", [], "any", false, false, false, 28), "html", null, true);
            yield "</td>
        <td>";
            // line 29
